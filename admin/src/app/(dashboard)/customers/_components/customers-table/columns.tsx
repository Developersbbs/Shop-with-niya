        ...
        return (
          <div className="flex items-center gap-1">
            <TooltipWrapper content="View Customer Orders">
              ...
              >
                <Link href={`/customer-orders/${row.original.id || row.original._id}`}>
            ...
            {hasPermission("customers", "canEdit") && (
              <CustomerFormSheet
                ...
                action={(formData) => editCustomer(row.original.id || row.original._id, formData)}
              >
            ...
            {hasPermission("customers", "canDelete") && (
              <TableActionAlertDialog
                ...
                queryKey="customers"
                action={() => deleteCustomer(row.original.id || row.original._id)}
              >
